        ...
        child: Material(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              Text(
                '(*) Exxe sẽ không chịu trách nhiệm mọi vấn đề liên quan việc dàn xếp chuyến xe ngoài hệ thống giữa khách hàng và tài xế',
                style: AppStyles.s10w6.withColor(AppColors.utilRed),
              )
            ],
          ),
        ),
